...
class UserService:
    ...
    def validate(self, username, password):
        ...
        # käyttäjänimi vähintään 3 merkkiä
        if len(username) < 3:
            raise UserInputError("Username too short")

        # sallitaan vain pienet kirjaimet (a–z)
        ...
        # salasana ei saa olla pelkkää kirjaimia
        if password.isalpha():
            raise UserInputError("Password must contain at least one non-letter")
